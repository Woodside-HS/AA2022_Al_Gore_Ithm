...
function Game(cnv,ctx){
  ...
  let enemies_1 = [ //populates enemy array with test enemies
    new Character(0,0,40,Color.generateRandomColor(1,1,255,false),12,100,this.ctx),
    new Character(0,0,45,Color.generateRandomColor(1,1,255,false),10,100,this.ctx),
    new Character(0,0,50,Color.generateRandomColor(1,1,255,false),8,100,this.ctx),
  ];
