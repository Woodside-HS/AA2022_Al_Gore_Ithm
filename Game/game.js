...
function Game(cnv,ctx){
  ...
  let enemies_1 = [ //populates enemy array with test enemies
    new Enemy(0,0,20,Color.generateRandomColor(255,1,1,false),2,100,this.cnv, this.ctx,"../Files/dubbya.jpeg"),
    new Enemy(0,0,15,Color.generateRandomColor(255,1,1,false),1.5,100,this.cnv, this.ctx,"../Files/cheney.jpg"),
