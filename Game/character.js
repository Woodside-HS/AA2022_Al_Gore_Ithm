function Character(x,y,rad,clr,speed,life,cnv,ctx,imgSrc,healthWidth,healthHeight,clrScale){
  ...
  this.particleSystem = new ParticleSystem(x,y,this.ctx,clrScale); //creates basic particle system
}
