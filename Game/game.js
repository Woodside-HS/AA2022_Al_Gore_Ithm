...
function Game(cnv,ctx){
  ...
  let enemies_1 = [ //populates enemy array with test enemies
    new Character(0,0,10,Color.generateRandomColor(255,1,1,false),12,100,this.ctx),
    new Character(0,0,15,Color.generateRandomColor(255,1,1,false),10,100,this.ctx),
    new Character(0,0,20,Color.generateRandomColor(255,1,1,false),8,100,this.ctx),
  ];
